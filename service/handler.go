...
// getSiteSettings 网站信息路由
func getSiteSettings(context *gin.Context, c *DatabaseConn) {
...
// getGroupsList 获取房间列表
func getGroupsList(context *gin.Context, c *DatabaseConn) {
...
// getHistoricalMessages 历史消息获取
func getHistoricalMessages(context *gin.Context, c *DatabaseConn, id string) {
